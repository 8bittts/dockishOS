...
# Single source of truth for release verification; also runnable by hand as
# ./scripts/smoke-test.sh --production
info "Running production smoke gate"
DOCKISHOS_VERSION="$RELEASE_VERSION" \
DOCKISHOS_BUILD="$RELEASE_BUILD" \
